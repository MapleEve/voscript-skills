...
本技能包同步 VoScript `v0.7.2` 的当前发布叙事与行为：roadmap visibility、
architecture foundation、stability hardening。对调用方来说，核心 HTTP
...
或完整 speaker memory 产品化。如果用户询问这些能力，应说明它们属于 roadmap
方向或后续版本，不要当作已交付功能。
